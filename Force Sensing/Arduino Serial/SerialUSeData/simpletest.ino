...
void loop() {
  ...
  a1 = String(a, BIN); //convert raw reading of HES 1 to string of bits
  a2 = a1.length(); //get length, necessary to evaluate MSB padding of zeros
  b1 = String(b, BIN); //convert raw reading of HES 2 to string of bits
  b2 = b1.length(); //get length, necessary to evaluate MSB padding of zeros
  c1 = String(c, BIN); //convert raw reading of HES 3 to string of bits
  c2 = c1.length(); //get length, necessary to evaluate MSB padding of zeros
  d1 = String(d, BIN); //convert raw reading of HES 4 to string of bits
